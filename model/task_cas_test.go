...
func truncateTables(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		DB.Exec("DELETE FROM pricing_recommendations")
		DB.Exec("DELETE FROM operating_insights")
		DB.Exec("DELETE FROM usage_ledgers")
		DB.Exec("DELETE FROM supply_prepaid_lots")
		DB.Exec("DELETE FROM supply_cost_profiles")
		DB.Exec("DELETE FROM supply_telemetry_agents")
		DB.Exec("DELETE FROM supply_capacity_telemetries")
		DB.Exec("DELETE FROM supply_capacities")
		DB.Exec("DELETE FROM sla_probe_runs")
		DB.Exec("DELETE FROM sla_probe_plans")
		DB.Exec("DELETE FROM sla_contracts")
		DB.Exec("DELETE FROM supply_routing_policies")
		DB.Exec("DELETE FROM supply_action_executions")
		DB.Exec("DELETE FROM supply_action_plans")
		DB.Exec("DELETE FROM supply_expansion_opportunities")
		DB.Exec("DELETE FROM supply_decisions")
		DB.Exec("DELETE FROM traffic_forecasts")
		DB.Exec("DELETE FROM traffic_profiles")
		DB.Exec("DELETE FROM supplier_evaluations")
		DB.Exec("DELETE FROM supplier_posture_recommendations")
		DB.Exec("DELETE FROM supplier_route_preferences")
		DB.Exec("DELETE FROM supplier_scorecards")
