...
export function ChannelMutateDrawer({
  ...
  let keyFieldDescription = t(FIELD_DESCRIPTIONS.KEY)
  if (isEditing) {
    keyFieldDescription = t(
      'Enter new key to update, or leave empty to keep current key'
    )
  } else if (isBatchMode) {
    keyFieldDescription = t('Enter one API key per line for batch creation')
  }
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormDescription>
                                {t(
                                  'Set 0 to leave this channel outside token-router supplier cost attribution.'
                                )}
                              </FormDescription>
                              <FormMessage />
                            </FormItem>
